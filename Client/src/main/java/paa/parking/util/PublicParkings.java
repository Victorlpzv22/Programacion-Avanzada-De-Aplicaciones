...
public class PublicParkings {
	public static Collection<Parking> listMadridParkings() {
		Vector<Parking> parkings = new Vector<>();
		parkings.add(new Parking(null, "Colón", "Plaza de Colón s/n", 100, 10, -3.6899392, 40.4247093));
		parkings.add(new Parking(null, "Corazón de María II", "C/ Corazón de María (final calle)", 100, 20, -3.6455254, 40.2991739));
		parkings.add(new Parking(null, "Encuentro", "Plaza Encuentro", 100, 20, -3.6513541, 40.4054645));
		parkings.add(new Parking(null, "Nuestra Señora del Recuerdo", "c/ Hiedra,  26", 100, 20, -3.67916, 40.472181));
